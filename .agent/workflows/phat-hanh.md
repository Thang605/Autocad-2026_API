...
```
Copy-Item -Path "c:\OneDrive\0.AI AGENT\6.C#\Autocad 2026_API\MyFirstProject\bin\Release\Civil3D_Tools.dll" -Destination "Y:\5.SOFT T27\1. FOR WORK\1. THIET KE DUONG\2.CIVIL 3D\2026\AutoCAD Civil 3D 2026 Win x64\x64\c3d\Civil3D2026.dll" -Force
```
